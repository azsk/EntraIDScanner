...
class AzSKPDFExtension
{
	...
	{
		# Get Context Info
		$executedBy = ([AccountHelper]::GetCurrentAzAcontext()).Account
		...
		If (test-path HKLM:SOFTWARE\Classes\Word.Application)
		{
			...
			try
			{
				...
				[AzSKPDFExtension]::WriteHeaderTableCell($AzSKTitleTable, 1, 'Subscription Name', $subscriptionObject.TenantName)
				[AzSKPDFExtension]::WriteHeaderTableCell($AzSKTitleTable, 2, 'tenantId', $subscriptionObject.tenantId)
